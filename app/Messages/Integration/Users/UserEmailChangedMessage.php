...
final readonly class UserEmailChangedMessage implements IntegrationMessageInterface
{
    ...
    public static function make(User $user, string $oldEmail, Systems $originSystem): self
    {
